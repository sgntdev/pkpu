							...
							<td class="px-4 py-3">
								<div class="inline-flex rounded-md shadow-sm" role="group">
									<a
										...
										class={`${data.status !== 1 && data.status !== 2 ? 'rounded-s-lg' : 'rounded-lg'} inline-flex items-center border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:text-white dark:focus:ring-blue-500`}
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											fill="none"
